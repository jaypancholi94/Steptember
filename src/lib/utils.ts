import {
  INITIAL_STEP_STATE,
  INITIAL_USER_STATE,
  LOCAL_STORAGE_STEP_KEY,
  LOCAL_STORAGE_USER_KEY,
} from '@/constants';
import type { StepState } from '@/store/reducers/step-slice';
import type { UserState } from '@/store/reducers/user-slice';
...
export const getLocalStepsData = () => {
  try {
    const data = localStorage.getItem(LOCAL_STORAGE_STEP_KEY);
    if (data) {
