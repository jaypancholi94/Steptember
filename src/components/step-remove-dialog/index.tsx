...
const StepRemoveDialog: React.FC<StepRemoveDialogProps> = memo(
  ({ stepIndex }) => {
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              <p className="opacity-60">
                Once they&apos;re gone, they&apos;re not coming back. Are you
                sure you want to erase this chapter?
              </p>
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
...
StepRemoveDialog.displayName = 'StepRemoveDialog';
